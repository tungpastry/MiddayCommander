...
const (
	// Keep startup responsive when a terminal ignores OSC color queries.
	// Apple Terminal can leave Bubble Tea v1 waiting here before main runs.
	OSCTimeout = 100 * time.Millisecond
)
